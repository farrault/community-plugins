...
package com.xebialabs.deployit.plugin.sql.support;
...
public class VelocityUtils {
	...
	public static String evaluateTemplate(Database db, String templateResourcePath) {
		VelocityContext context = new VelocityContext();
		context.put("ci", db);
		return evaluateTemplate(context, templateResourcePath);
	}
	...
	public static String evaluateTemplate(VelocityContext context, String templateResourcePath) {
		...
		try {
			...
			throw new RuntimeIOException("Cannot open template file " + templateResourcePath, exc);
		}
