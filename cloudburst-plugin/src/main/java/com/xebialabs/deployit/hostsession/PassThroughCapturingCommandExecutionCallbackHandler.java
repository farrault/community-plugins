...
/**
 * An implementation of the {@link CommandExecutionCallbackHandler} that captures the output in variables <em>and</em> passes it on to 
 */
public final class PassThroughCapturingCommandExecutionCallbackHandler implements CommandExecutionCallbackHandler {
	...
	public void handleOutputLine(String line) {
		...
		allLines.add(line);
		originalHandler.handleOutputLine(line);
	}
	...
	public void handleErrorLine(String line) {
		...
		errorLines.add(line);
		allLines.add(line);
		originalHandler.handleErrorLine(line);
	}

	public void handleOutput(char c) {
		originalHandler.handleOutput(c);
	}
